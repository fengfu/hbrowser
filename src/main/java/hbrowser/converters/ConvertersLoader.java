...
import hbrowser.reflection.JavaPackage;
...
public class ConvertersLoader {
    ...
    private static boolean deleteConverter(String name) {
        ...
        if (converter != null) {
            ...
            File classFile = new File(
                PathHelper.append(
                    PathHelper.append(GlobalConfig.instance().getConvertersClassesFolder(), "hbrowser/converters/custom"),
    ...
    private static Map<String, TypeConverter> load() {
        ...
        loadPackage("hbrowser.converters", map);
        loadFolder(GlobalConfig.instance().getConvertersClassesFolder(), "hbrowser.converters.custom", map);
