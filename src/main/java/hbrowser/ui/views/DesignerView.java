package hbrowser.ui.views;

import com.intellij.uiDesigner.core.GridConstraints;
import com.intellij.uiDesigner.core.GridLayoutManager;
import com.intellij.uiDesigner.core.Spacer;
import hbrowser.actions.Action;
import hbrowser.actions.RunnableAction;
import hbrowser.config.ClusterConfig;
import hbrowser.config.GlobalConfig;
import hbrowser.converters.ConvertersLoader;
import hbrowser.converters.ConvertersLoaderHandler;
import hbrowser.converters.TypeConverter;
import hbrowser.data.*;
import hbrowser.export.FileExporter;
import hbrowser.filters.EmptyFilter;
import hbrowser.filters.Filter;
import hbrowser.filters.PatternFilter;
import hbrowser.hbase.*;
import hbrowser.io.PathHelper;
import hbrowser.system.ClipboardData;
import hbrowser.system.ClipboardListener;
import hbrowser.system.InMemoryClipboard;
import hbrowser.ui.*;
import hbrowser.ui.controls.WideComboBox;
import hbrowser.ui.design.*;
import hbrowser.ui.forms.*;
...
public class DesignerView {
    ...
    public DesignerView(final JPanel owner, final Connection connection) {
        ...
        columnScan.registerKeyboardAction(
                new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        clearError();
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (tableName != null) {
                            ...
                            try {
                                ...
                                //for export purpose, should set forwardNavigationOnly=true to avoid memory waste
                                scanner.setForwardNavigateOnly(true);
        ...
        columnRefresh.registerKeyboardAction(
                new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        clearError();
    ...
    private void loadTables() {
        ...
        try {
            ...
            tablesNumber.setText(String.format("%s / %s", tablesListModel.getSize(), tablesCount));
    ...
    private void initializeColumnsTable() {
        ...
        columnsTableModel.addColumn("显示");
        columnsTableModel.addColumn("列名");
        columnsTableModel.addColumn("类型");
        ...
        columnsTable.setGridColor(Color.lightGray);

        columnsTable.getColumn("显示").setCellRenderer(new JCheckBoxRenderer(new CheckedRow(1, ColumnQualifier.KEY)));
        columnsTable.getColumn("显示").setCellEditor(new JCheckBoxRenderer(new CheckedRow(1, ColumnQualifier.KEY)));
        columnsTable.getColumn("显示").setPreferredWidth(50);
        columnsTable.getColumn("显示").setMaxWidth(50);
        columnsTable.getColumn("显示").setMinWidth(50);
        ...
        columnConverters.setSelectedItem(ColumnType.BinaryString);
        columnsTable.getColumn("类型").setCellEditor(new DefaultCellEditor(cmbColumnTypes));
        columnsTable.getColumn("类型").setPreferredWidth(82);
        columnsTable.getColumn("类型").setMaxWidth(300);
        columnsTable.getColumn("类型").setMinWidth(82);
    ...
    private void initializeRowsTable() {
        ...
        rowsTable.setGridColor(Color.lightGray);
    ...
    private void loadColumns(String tableName, DataRow row) {
        ...
        try {
            ...
            columnsNumber.setText(String.format("%s / %s", columnsTableModel.getRowCount(), columns.size()));
        } catch (Exception ex) {
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        tableRefresh.setToolTipText("刷新");
        ...
        Font tableFiltersFont = this.$$$getFont$$$(null, -1, -1, tableFilters.getFont());
        if (tableFiltersFont != null) tableFilters.setFont(tableFiltersFont);
        ...
        tableDelete.setText("");
        tableDelete.setToolTipText("删除选定的表");
        ...
        tableTruncate.setToolTipText("清空选定的表");
        ...
        tableCopy.setText("");
        tableCopy.setToolTipText("复制表信息到剪切板");
        ...
        tablePaste.setText("");
        tablePaste.setToolTipText("从剪切板粘贴表信息");
        ...
        tableExport.setText("");
        tableExport.setToolTipText("导出表数据");
        ...
        tableImport.setText("");
        tableImport.setToolTipText("导入数据");
        ...
        tableFlush.setText("");
        tableFlush.setToolTipText("强制HBase刷新数据到HFile");
        ...
        tableMetadata.setToolTipText("显示表信息");
        ...
        columnRefresh.setToolTipText("刷新列");
        ...
        columnScan.setText("");
        columnScan.setToolTipText("高级检索");
        ...
        columnJump.setText("");
        columnJump.setToolTipText("跳转到指定的行");
        ...
        columnCheck.setText("");
        columnCheck.setToolTipText("选择所有列");
        ...
        columnUncheck.setToolTipText("反选所有列");
        ...
        columnConverters.setToolTipText("选择列格式转换类型");
        ...
        columnAddConverter.setToolTipText("添加自定义转换");
        ...
        columnEditConverter.setToolTipText("编辑自定义转换");
        ...
        columnDeleteConverter.setToolTipText("删除自定义转换");
        ...
        rowOpen.setText("");
        rowOpen.setToolTipText("在外部程序打开数据");
        ...
        rowDelete.setText("");
        rowDelete.setToolTipText("删除选定的行");
        ...
        rowCopy.setText("");
        rowCopy.setToolTipText("复制选定的行到剪切板");
        ...
        rowPaste.setText("");
        rowPaste.setToolTipText("从剪切板粘贴到选定的行");
        ...
        rowSave.setText("");
        rowSave.setToolTipText("保存修改的数据到HBase");
