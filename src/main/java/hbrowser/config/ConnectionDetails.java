...
public class ConnectionDetails implements Serializable {
    ...
    public Configuration createConfig() {
        ...
        config.set("zookeeper.znode.parent", this.zookeeper.getNode());
        config.set("zookeeper.session.timeout", "900000");
...
//        config.set("zookeeper.znode.parent", "/hbase/cluster_new1");
//        config.set("zookeeper.znode.parent", "/hbase/flight-atpco");
