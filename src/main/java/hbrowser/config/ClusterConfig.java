...
public class ClusterConfig extends PropertiesConfig {
    ...
    public ConnectionDetails getConnection() {
        ...
        final String zookeeperNode = get(String.class, "connection.zookeeper.node", null);
        final String zookeeperPort = get(String.class, "connection.zookeeper.port", null);

        if (zookeeperHost == null || zookeeperNode == null || zookeeperPort == null) {
            return null;
        }

        return new ConnectionDetails() {{
            setZookeeper(new ServerDetails(zookeeperHost, zookeeperNode, zookeeperPort));
        }};
    }
    ...
    public void setConnection(ConnectionDetails connection) {
        ...
        set("connection.zookeeper.node", connection.getZookeeper().getNode());
