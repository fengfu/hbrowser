...
public class Connection {
    ...
    public void saveTable(String tableName, String path) throws IOException {
        ...
        StoreFile.WriterBuilder builder = new StoreFile.WriterBuilder(
                this.getConfiguration(), new CacheConfig(cacheConfig), fs).withFilePath(filePath);
    ...
    public void loadTable(String tableName, String path) throws IOException, TableNotFoundException {
        ...
        StoreFile.Reader reader = new StoreFile.Reader(fs, new Path(path), new CacheConfig(this.getConfiguration()), this.getConfiguration());
...
//                KeyValue kv = scanner.next();
                ...
                isValid = cell != null;
                if (isValid) {
                    ColumnFamily columnFamily = new ColumnFamily(Bytes.toStringBinary(cell.getFamily()));
                    ...
                    if (!Arrays.equals(put.getRow(), cell.getRow())) {
                        for (HbaseActionListener listener : this.listeners) {
